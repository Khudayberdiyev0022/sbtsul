...
import img1 from '../../../assets/img/djuraev.jpg'
import img2 from '../../../assets/img/xurozov.jpg'
        ...
        <div className={style.container}>
          <div className={style.text}>
            ...
            <Link to="/rahbariyat">Rahbariyat</Link>
              ...
              <p className={style.rektor}>Oʼquv-tarbiyaviy ishlar boʼyicha direktor oʼrinbosari</p>
              <p>
          ...
          <div className={style.img1} style={{backgroundImage:`url(${img1})`}} ></div>
        </div>
      </div>
      <div className={style.sec2}>
        <div className={style.img} style={{backgroundImage:`url(${img2})`}} ></div>
          <div className={style.content} >
            ...
            <p className={style.rektor}>Moliya-xoʼjalik ishlari boʼyicha direktori oʼrinbosari</p>
            <p>
              Toshkent davlat yuridik universitetining Ixtisoslashtirilgan filiali
